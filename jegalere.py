...
def test_3():
    ...
    obstacle1 = Obstacle([-100,100.1,100,100])
    obstacle2 = Obstacle([-100.1,100,-100,-100])
    obstacle3 = Obstacle([50,100,-100,100.1])
    liste_obstacle = [obstacle1,obstacle2,obstacle3]
